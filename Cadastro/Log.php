	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                            <form class="login100-form validate-form" action="vdados.php" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate="Digite seu nick">
						...
						<input class="input100" type="text" name="nick" placeholder="Nickname...">
					...
					<div class="container-login100-form-btn">
						<div class="wrap-login100-form-btn">
							...
							<button class="login100-form-btn">
                                            ...
                                            <a href="Cad.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Cadastrar
